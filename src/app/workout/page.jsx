...
export default function page() {
  ...
  const getFillColor = (muscleGroup) => {
    return hoveredArea === muscleGroup ? 'rgba(249, 115, 22, 0.4)' : 'transparent';
  };
      ...
      <div className="muscle-map-container relative w-full max-w-[500px] mx-auto bg-gray-800 rounded-lg p-4 shadow-xl">
        <div className="relative">
          <div className="absolute inset-0">
            <Image src={svgimg} alt="Anatomical figure" className="w-full h-full object-contain" />
          </div>
